    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-28 pb-16">
        <div className="container mx-auto px-4 md:px-8 max-w-3xl">
          <h1 className="page-title font-serif font-bold text-foreground mb-2 opacity-0 animate-fade-in" style={{ animationDelay: "0.1s" }}>Your Cart</h1>
          ...
          {items.length === 0 ? (
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button className="flex-1" size="lg" onClick={handleCheckoutClick}>
